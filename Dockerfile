...
RUN apt-get update && apt-get install -y openjdk-11-jre-headless unzip perl wget && wget https://www.bioinformatics.babraham.ac.uk/projects/fastqc/fastqc_v0.12.1.zip && \ 
